...
TESTS = ["test_resume.py", "test_lock.py", "test_json_toolcall.py",
         ...
         "test_local.py", "test_guardrails.py", "test_url.py",
         "test_hardening.py", "test_csrf.py",
         "test_fleet.py", "test_ui.py", "test_remote.py", "test_material.py",
         "test_frontend.py", "test_layers.py", "test_team.py", "test_audit.py",
         ...
         "test_sandbox.py", "test_skillmd.py", "test_decisions.py",
         "test_modelrouter.py", "test_routines.py", "test_trace.py",
         "test_events.py", "test_uicards.py", "test_panel_v2.py",
         "test_bootstrap.py", "test_secrets.py", "test_conflicts.py",
         "test_awareness.py", "test_design.py", "test_backup.py",
         "test_preflight.py", "test_chaos.py", "test_candidates.py",
