...
learned. 81 Python modules, 111 acceptance tests, one HTML control panel, no
...
111 acceptance tests, green on Windows under Python 3.14 and on Linux under
...
python tests/run_all.py   # 111 acceptance tests
