...
learned. 108 Python modules, 141 acceptance tests, one HTML control panel, no
...
141 acceptance tests, green on Windows and Linux under
...
python tests/run_all.py   # 141 acceptance tests
