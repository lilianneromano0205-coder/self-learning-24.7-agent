...
learned. 112 Python modules, 148 acceptance tests, one HTML control panel, no
...
148 acceptance tests, green on Windows and Linux under
...
python tests/run_all.py   # 148 acceptance tests
