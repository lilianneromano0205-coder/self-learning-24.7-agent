...
learned. 112 Python modules, 147 acceptance tests, one HTML control panel, no
...
147 acceptance tests, green on Windows and Linux under
...
python tests/run_all.py   # 147 acceptance tests
