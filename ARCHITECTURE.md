...
learned. 112 Python modules, 145 acceptance tests, one HTML control panel, no
...
145 acceptance tests, green on Windows and Linux under
...
python tests/run_all.py   # 145 acceptance tests
