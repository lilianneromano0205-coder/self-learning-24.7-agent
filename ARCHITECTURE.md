...
learned. 112 Python modules, 146 acceptance tests, one HTML control panel, no
...
146 acceptance tests, green on Windows and Linux under
...
python tests/run_all.py   # 146 acceptance tests
