...
learned. 107 Python modules, 140 acceptance tests, one HTML control panel, no
...
140 acceptance tests, green on Windows and Linux under
...
python tests/run_all.py   # 140 acceptance tests
