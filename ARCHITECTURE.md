...
learned. 111 Python modules, 144 acceptance tests, one HTML control panel, no
...
144 acceptance tests, green on Windows and Linux under
...
python tests/run_all.py   # 144 acceptance tests
