...
![tests](https://img.shields.io/badge/tests-150%20passing%20%C2%B7%206%20platforms-brightgreen)
![mutations](https://img.shields.io/badge/mutation%20tests-32%20mutations%20%C2%B7%200%20missed-brightgreen)
![license](https://img.shields.io/badge/license-AGPL--3.0-orange)

113 Python modules · 150 acceptance tests · one HTML control panel · no
...
| Dependencies | large stacks | Python stdlib. Zero. 150 tests on 6 CI platforms |
...
python tests/run_all.py   # 150 acceptance tests
