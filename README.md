...
![tests](https://img.shields.io/badge/tests-153%20passing%20%C2%B7%206%20platforms-brightgreen)
![mutations](https://img.shields.io/badge/mutation%20tests-32%20mutations%20%C2%B7%200%20missed-brightgreen)
![license](https://img.shields.io/badge/license-AGPL--3.0-orange)

115 Python modules · 153 acceptance tests · one HTML control panel · no
...
| Dependencies | large stacks | Python stdlib. Zero. 153 tests on 6 CI platforms |
...
python tests/run_all.py   # 153 acceptance tests
